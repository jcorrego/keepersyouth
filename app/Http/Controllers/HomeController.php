...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $services[]  = [
          ...
          'subtitle'    => 'Prácticas, Profundas y Posibles',
          'description' => 'Elaboramos y distribuimos enseñanzas, estudios y reflexiones Prácticas, Profundas y Posibles, de fácil lectura y comprensión para los adolescentes y jóvenes de las iglesias y los no creyentes. Estas son de soporte y ayuda en los ministerios juveniles para obtener materiales de enseñanza ordenados y consecutivos para sus reuniones y escuelas bíblicas.',
        ];
        $services[]  = [
          'id'          => '3',
          'name'        => 'H2J',
          ...
          'subtitle'    => 'Hermenéutica y Homilética juvenil',
          'description' => 'Enseñamos y entrenamos a líderes de jóvenes en preparar la enseñanza Biblica y trasmitirla de manera creativa y relevante para adolescentes y jovenes. Proveemos herramientas didácticas y contextualizadas para la enseñanza en el ministerio juvenil.',
        ];
        $services[]  = [
          'id'          => '4',
          'name'        => 'Keepers School',
